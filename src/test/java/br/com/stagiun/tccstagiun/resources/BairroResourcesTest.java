...
//@Profile("Test")
@Slf4j
public class BairroResourcesTest {
    ...
    public void find_by_countries_and_thenStatus200_and_all_bairro() throws Exception {
        ...
        mockMvc.perform(get("/v1/bairros"))
                .andDo(print())
                .andExpect(content().json("[{\"descricao\":\"Centro\",\"cidade\":{\"id\":1,\"descricao\":\"Uberlandia\"}},{\"descricao\":\"Centro\",\"cidade\":{\"id\":2,\"descricao\":\"Uberaba\"}},{\"descricao\":\"Centro\",\"cidade\":{\"id\":3,\"descricao\":\"Araguar\"}}]"))
                .andExpect(status().isOk());
    }
